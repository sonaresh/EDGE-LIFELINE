...
- Phase 9 packages accepted evidence; it does not create new experimental evidence.
- All underlying workloads and hospital scenarios are synthetic and nonclinical.
- H4 values are host-specific software measurements, not clinical or physical-effect latency.
